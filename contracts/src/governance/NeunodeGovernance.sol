...
contract NeunodeGovernance is AccessControl, Pausable, IGovernance {
    ...
    error VotingDelayBelowMinimum(uint256 delay, uint256 minimum);
    error VotingPeriodBelowMinimum(uint256 period, uint256 minimum);
    error TimelockBelowMinimum(uint256 timelock, uint256 minimum);
