...
export function createReputationResource(client: NeunodeClient): ReputationResource {
  ...
  return {
    ...
    async attest(params: ReputationAttestParams): Promise<ReputationAttestResult> {
      const args = ["reputation", "attest", "--to", params.to, "--score", String(params.score)];
