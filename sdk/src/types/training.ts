...
import type { Did, JobId, Timestamp, TokenAmount } from "./core.js";
...
export type SettlementStatus =
	(typeof SettlementStatusValues)[keyof typeof SettlementStatusValues];
...
export type AggregationMode =
	(typeof AggregationMode)[keyof typeof AggregationMode];
...
export type TrainingProviderStatus =
	(typeof TrainingProviderStatus)[keyof typeof TrainingProviderStatus];
...
export type GradientWireFormat =
	(typeof GradientWireFormat)[keyof typeof GradientWireFormat];
...
export type FaultEventInfo =
	| {
			readonly type: "WorkerSuspect";
			readonly worker_id: Did;
			readonly details: string;
	  }
	| {
			readonly type: "WorkerDead";
			readonly worker_id: Did;
			readonly details: string;
	  }
	| {
			readonly type: "WorkerRecovered";
			readonly worker_id: Did;
			readonly details: string;
	  }
	| {
			readonly type: "RecoveryNeeded";
			readonly worker_id: Did;
			readonly details: string;
	  };
