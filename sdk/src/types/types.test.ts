...
import { MessageRole, FinishReason, ProviderStatus, RoutingStrategy } from "./inference.js";
import { TrainingStatus, ContributionType } from "./model.js";
...
describe("Kind enum", () => {
  const kindKeys = [
    "AgentAnnounce", "AgentUpdate", "Ping", "Pong", "Error", "Metadata",
    "BountyPost", "BountyClaim", "BountySubmit", "BountyReview",
    "BountyAccept", "BountyReject", "BountyDispute", "BountyResolve",
    "BountyPay", "BountyCancel", "BountyExpire",
    "TrainingStart", "TrainingProgress", "TrainingComplete", "TrainingFailed",
    "Attestation", "AttestationRevoke",
...
describe("KindCategory enum", () => {
  const categories = ["System", "Bounty", "Training", "Attestation", "Inference", "Governance", "Custom", "Unknown"] as const;
...
describe("BountyState", () => {
  const states = ["Open", "Claimed", "Submitted", "UnderReview", "Revision",
    "Accepted", "Rejected", "Disputed", "Paid", "Expired", "Cancelled"] as const;
...
describe("Discriminated union narrowing", () => {
  describe("BountyEvent", () => {
    it("should narrow to Claim type", () => {
      const event: BountyEvent = { type: "Claim", claimant: "did:neunode:abc" as never, bond: 100n as never };
      if (event.type === "Claim") {
    ...
    it("should narrow to Submit type", () => {
      const event: BountyEvent = { type: "Submit", artifact_hash: "sha256:abc" as never };
  ...
  describe("NodeEvent", () => {
    ...
    it("should narrow to PeerConnected type", () => {
      const event: NodeEvent = { type: "PeerConnected", peer_id: "12D3KooW..." as never };
    ...
    it("should narrow to PeerDisconnected type", () => {
      const event: NodeEvent = { type: "PeerDisconnected", peer_id: "12D3KooW..." as never };
    ...
    it("should narrow to IdentifyReceived type", () => {
      const event: NodeEvent = { type: "IdentifyReceived", peer_id: "12D3KooW..." as never, agent_version: "agnetd/0.1" };
    ...
    it("should narrow to PingResult type", () => {
      const event: NodeEvent = { type: "PingResult", peer_id: "12D3KooW..." as never, rtt_ms: 42 };
