...
export type NodeEvent =
  | { readonly type: 'GossipsubMessage'; readonly source?: PeerId; readonly topic: string; readonly data: Uint8Array }
  | { readonly type: 'PeerConnected'; readonly peer_id: PeerId }
  | { readonly type: 'PeerDisconnected'; readonly peer_id: PeerId }
  | { readonly type: 'IdentifyReceived'; readonly peer_id: PeerId; readonly agent_version: string }
  | { readonly type: 'PingResult'; readonly peer_id: PeerId; readonly rtt_ms: number };
