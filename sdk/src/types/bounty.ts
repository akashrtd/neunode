...
export type BountyEvent =
  | { readonly type: 'Claim'; readonly claimant: Did; readonly bond: TokenAmount }
  | { readonly type: 'Submit'; readonly artifact_hash: Hash256 }
  | { readonly type: 'StartReview' }
  | { readonly type: 'SubmitReview'; readonly reviewer: Did; readonly score: number; readonly notes: string; readonly signature?: Signature }
